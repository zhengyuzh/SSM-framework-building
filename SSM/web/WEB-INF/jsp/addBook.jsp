    ...
    <form action="${pageContext.request.contextPath}/book/addBook" method="post">
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-3"><input type="text" class="form-control col-md-6 " name="bookId" id="bookId"
                                             onblur=" return checkID()"></div>
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-3"><input type="text" class="form-control" name="bookName" id="bookName"
                                             onblur="return checkName()"></div>
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-3"><input type="text" class="form-control" name="bookCounts" id="bookCounts"
                                             onblur="return checkCount()"></div>
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-3"><textarea name="detail" class="form-control" rows="3" cols="4" id="detail"
                                                onblur="return checkDeatil()"></textarea></div>
